...
public protocol KeyboardFrameTrackerDelegate: class {
    func keyboardFrameDidChange(with frame: CGRect)
}

public class KeyboardFrameTrackerView: UIView {
    /// Set your self as the delegate
    /// if you want to observe keyboard frame changes in a delegate style
    public weak var delegate: KeyboardFrameTrackerDelegate?
